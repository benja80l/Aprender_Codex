...
function renderizarTareas(tareas) {
  ...
  tareas.forEach((tarea, indice) => {
    ...
    btnEliminar.addEventListener('click', (e) => {
      e.stopPropagation(); // Evita que el click en el botón dispare el evento del li
    ...
    li.addEventListener('click', (e) => {
      // Evita conflicto si el click fue en el checkbox o el botón eliminar
      if (e.target === checkbox || e.target === btnEliminar || btnEliminar.contains(e.target)) return;
